    ...
    <>
        ...
        <div className="hero-grid sec-inner">
          ...
          <div>
            ...
            <div className="fu d4 hero-trust">
              Free plan available · No download required · Private
            </div>
          </div>
      ...
      <div className="proof-strip">
        <div className="proof-inner">
          {[
            { stat: 'Public Beta',      sub: 'Early access'               },
        ...
        <div className="fu sec-inner">
          <div style={{ maxWidth: 680, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
              ...
              <div style={{ fontSize: 13, color: C.dim }}>Free plan available · Upgrade anytime</div>
            </div>
          </div>
        </div>
      </section>
