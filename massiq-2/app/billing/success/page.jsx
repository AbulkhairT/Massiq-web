...
import { initializeSession, getStoredSession, getProfile, getSubscription } from '../../../lib/supabase/client';
    ...
    const waitForSession = async () => {
      ...
      for (let i = 0; i < 10; i++) {
        ...
        if (cached?.access_token) {
          session = await initializeSession().catch(() => cached);
          if (session?.access_token) return session;
        }
      }
      return null;
      ...
      <div style={{ maxWidth: 420, width: '100%', textAlign: 'center' }}>
        ...
        {stage === 'unauthenticated' && (
          <>
            ...
            <div style={{ fontSize: 14, color: C.muted, lineHeight: 1.6, marginBottom: 28 }}>
              Taking you back to the app to complete premium activation.
            </div>
            <button
